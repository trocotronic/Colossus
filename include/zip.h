...
extern int zip_init(struct _sock *, int);
extern void zip_free(struct _sock *);
extern char *unzip_packet(struct _sock *, char *, int *);
extern char *zip_buffer(struct _sock *, char *, int *, int);
