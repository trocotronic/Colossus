...
int BidleSQL()
{
	SQLNuevaTabla(GS_BIDLE, "CREATE TABLE IF NOT EXISTS %s%s ( "
		...
		"pen_msg int default '0', pen_nick int default '0', pen_part int default '0', pen_kick int default '0', pen_quit int default '0', pen_quest int default '0', pen_logout int default '0', "
		"creado int default '0', "
		...
		"arma varchar(32), "
		"oro int default '0', "
		"mejora int default '0', "
		"claner int default '0', "
