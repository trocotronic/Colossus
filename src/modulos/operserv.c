...
BOTFUNCHELP(OSHSpam)
{
	...
	Responde(cl, CLI(operserv), " ");
	Responde(cl, CLI(operserv), "Los tipos son los objetivos de los spam (pueden combinarse para que una palabra o  expresión se aplique a más de un objetivo), los permitidos son:");
	Responde(cl, CLI(operserv), "\00312c\003 Mensaje a canal.");
	Responde(cl, CLI(operserv), "\00312p\003 Mensaje privado.");
	Responde(cl, CLI(operserv), "\00312n\003 Notice privado.");
	Responde(cl, CLI(operserv), "\00312N\003 Notice a canal.");
	Responde(cl, CLI(operserv), "\00312P\003 Mensaje de part.");
	Responde(cl, CLI(operserv), "\00312q\003 Mensaje de quit.");
	Responde(cl, CLI(operserv), "\00312d\003 Archivo DCC.");
	Responde(cl, CLI(operserv), "\00312u\003 Mensaje de away.");
	Responde(cl, CLI(operserv), "\00312a\003 Topic.");
	Responde(cl, CLI(operserv), "\00312t\003 Información de usuario (nick!user@host:real name).");
	Responde(cl, CLI(operserv), " ");
	Responde(cl, CLI(operserv), "Las acciones son la respuesta de los services ante el spam (la acción debe ser única), las permitidas son:");
	Responde(cl, CLI(operserv), "\00312b\003 Bloquea la acción.");
	Responde(cl, CLI(operserv), "\00312d\003 Bloquea todos los envios DCCs.");
	Responde(cl, CLI(operserv), "\00312g\003 Añade una gline al host.");
	Responde(cl, CLI(operserv), "\00312k\003 Añade una kline al host.");
	Responde(cl, CLI(operserv), "\00312K\003 Desconecta al usuario.");
	Responde(cl, CLI(operserv), "\00312s\003 Añade un shun al host.");
	Responde(cl, CLI(operserv), "\00312S\003 Añade un shun a la sesión actual del usuario (si reconecta el shun desaparece).");
	Responde(cl, CLI(operserv), "\00312v\003 Fuerza la salida de todos los canales, fuerza su entrada al canal de SPAM especificado en la configuración.");
	Responde(cl, CLI(operserv), "\00312z\003 Añade una zline al host.");
	Responde(cl, CLI(operserv), "\00312Z\003 Añade una gzline al host.");
	Responde(cl, CLI(operserv), " ");
	Responde(cl, CLI(operserv), "Añadir SPAM:");
	Responde(cl, CLI(operserv), "Sintaxis: \00312SPAM +spam [tipo] [acción] [motivo]");
	Responde(cl, CLI(operserv), "Ejemplo: \00312SPAM +irc-hispano cpnNPqduat b Publicidad No Permitida");
