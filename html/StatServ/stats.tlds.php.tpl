<chart>
	...
	<chart_data>
		<row>
			<null/>
			@TLDS_INICIO@
			<string>@TLDS_NOMBRE@</string>
			@TLDS_FIN@
		</row>
		<row>
			<string></string>
			@TLDS_INICIO@
			<number>@TLDS_VALOR@</number>
			@TLDS_FIN@
		</row>
	</chart_data>
	...
	<draw>
		<text color='000000' alpha='4' size='40' x='-50' y='260' width='500' height='50' h_align='center' v_align='middle'>.com.net.org.edu.info.mobi</text>
		<text color='000000' alpha='30' font='arial' rotation='0' bold='true' size='30' x='0' y='0' width='400' height='150' h_align='left' v_align='top'>estadisticas por dominios</text>
	</draw>
