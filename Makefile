...
src/eventos.obj: src/eventos.c $(INCLUDES)
	$(CC) $(EXECFLAGS) src/eventos.c
	
src/cripto.obj: src/cripto.c $(INCLUDES)
	$(CC) $(EXECFLAGS) src/cripto.c
	
src/socksint.obj: src/socksint.c $(INCLUDES)
	$(CC) $(EXECFLAGS) src/socksint.c
	
src/core.obj: src/core.c $(INCLUDES)
	$(CC) $(EXECFLAGS) src/core.c
	
src/misc.obj: src/misc.c $(INCLUDES)
