## $Id: Makefile,v 1.21 2006-12-23 00:32:24 Trocotronic Exp $
...
src/sql/mysql.dll: src/sql/mysql.c $(INCLUDES)
	$(CC) $(SQLCFLAGS) /I "C:\dev\mysql-5.0.27\include" src/sql/mysql.c \
	$(SQLLFLAGS) /LIBPATH:"C:\dev\mysql-5.0.27\lib_release" mysqlclient.lib \
